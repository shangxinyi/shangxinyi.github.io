...
You can reach me at [xinyi.shang.23 [at] ucl.ac.uk](mailto:xinyi.shang.23@ucl.ac.uk), and find my publications on <a href='https://scholar.google.com/citations?hl=zh-CN&user=pkfBYHAAAAAJ'>Google Scholar</a> <a href='https://scholar.google.com/citations?hl=zh-CN&user=pkfBYHAAAAAJ' style="text-decoration:none;display:inline-block;vertical-align:middle;font-family:'DejaVu Sans',Verdana,sans-serif;font-size:11px;line-height:20px;height:20px;border-radius:3px;overflow:hidden;"><span style="background-image:linear-gradient(to bottom, rgba(255,255,255,0.1), rgba(0,0,0,0.15));background-color:#555;color:#fff;padding:0 6px;display:inline-block;height:20px;text-shadow:0 -1px 0 rgba(0,0,0,0.3);"><i class="fas fa-graduation-cap" style="margin-right:4px;"></i>citations</span><span style="background-image:linear-gradient(to bottom, rgba(255,255,255,0.1), rgba(0,0,0,0.15));background-color:#007ec6;color:#fff;padding:0 6px;display:inline-block;height:20px;text-shadow:0 -1px 0 rgba(0,0,0,0.3);"><span id="total_cit">…</span></span></a>.
...
**[2]** [From Masks to Pixels and Meaning: A New Taxonomy, Benchmark, and Metrics for VLM Image Tampering](https://arxiv.org/pdf/2603.20193) \| <a href='https://github.com/VILA-Lab/PIXAR'><i class="fab fa-github" style="margin-right:3px;color:#000;"></i>[code]</a>
